...
def main():
    ...
    trainer = pl.Trainer(max_epochs=args.max_epochs, gpus=args.gpus, callbacks=callbacks, logger=logger,enable_checkpointing=True, default_root_dir="training/logs")
